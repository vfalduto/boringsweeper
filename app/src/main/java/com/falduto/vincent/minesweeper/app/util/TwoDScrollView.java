...
public class TwoDScrollView extends FrameLayout {
    ...
    public void center() {
        int centerX = (int) this.getChildAt(0).getWidth() / 2 - this.getWidth() / 2;
        int centerY = (int) this.getChildAt(0).getHeight() / 2 - this.getHeight() / 2;

        this.smoothScrollTo(centerX, centerY);
    }
}